...
public class SearchController {
    ...
    public ResponseBean searchDynamic(@PathVariable("message") String message,@PathVariable("pageNum") int pageNum){
        return new ResponseBean(200,"ok",iSearchService.dynamics(message,pageNum,20));
    }
